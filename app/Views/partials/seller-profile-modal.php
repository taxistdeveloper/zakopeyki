        ...
        <div id="seller-profile-body" class="hidden flex-1 min-h-0 overflow-y-auto">
            <div class="bg-white dark:bg-ink-900 border-b border-black/[0.06] dark:border-white/10 px-4 sm:px-6 py-5">
                <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                    <div id="seller-profile-avatar-wrap" class="shrink-0">
                        <span id="seller-profile-avatar" class="zk-medal-avatar w-[72px] h-[72px] sm:w-20 sm:h-20 block" aria-hidden="true">
                            <span class="zk-medal-avatar__face"></span>
                            <img class="zk-medal-avatar__ring" src="<?= htmlspecialchars(\App\Helpers\AvatarHelper::frameUrl()) ?>" srcset="<?= htmlspecialchars(\App\Helpers\AvatarHelper::frameUrl(true)) ?> 2x" alt="">
                        </span>
                    </div>
