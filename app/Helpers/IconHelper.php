...
class IconHelper
{
    ...
    private const PATHS = [
        ...
        'mic' => '<path d="M12 3a3 3 0 0 0-3 3v4a3 3 0 0 0 6 0V6a3 3 0 0 0-3-3z"/><path d="M19 10v1a7 7 0 0 1-14 0v-1"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/>',
    ...
    public static function svg(string $name, string $class = 'w-5 h-5', string $strokeWidth = '1.75'): string
    {
        $paths = self::PATHS[$name] ?? self::PATHS['package'];
        $class = htmlspecialchars($class, ENT_QUOTES, 'UTF-8');
        $strokeWidth = htmlspecialchars($strokeWidth, ENT_QUOTES, 'UTF-8');
