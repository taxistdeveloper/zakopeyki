...
CREATE TABLE IF NOT EXISTS users (
    ...
    permissions TEXT DEFAULT NULL COMMENT 'JSON permissions for manager',
...
CREATE TABLE IF NOT EXISTS products (
    ...
    type ENUM('used','new','auction','free','exchange','service','course','gig') NOT NULL,
    ...
    auction_kind VARCHAR(20) NOT NULL DEFAULT 'english',
    auction_reserve INT UNSIGNED DEFAULT NULL,
    auction_buy_now INT UNSIGNED DEFAULT NULL,
    auction_min_price INT UNSIGNED DEFAULT NULL,
    auction_step_interval INT UNSIGNED DEFAULT NULL,
    auction_start_at DATETIME DEFAULT NULL,
    auction_end_at DATETIME DEFAULT NULL,
    anti_snipe_seconds INT UNSIGNED NOT NULL DEFAULT 30,
    auto_extend_seconds INT UNSIGNED NOT NULL DEFAULT 120,
    inactivity_timeout_seconds INT UNSIGNED DEFAULT NULL,
