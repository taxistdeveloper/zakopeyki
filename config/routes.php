...
$router->post('/orders/{id}/return-accept', [OrderController::class, 'sellerAcceptReturn']);
$router->post('/orders/{id}/return-partial', [OrderController::class, 'sellerOfferPartial']);
$router->post('/orders/{id}/return-decline', [OrderController::class, 'sellerDeclineReturn']);
$router->post('/orders/{id}/return-partial-accept', [OrderController::class, 'buyerAcceptPartial']);
$router->post('/orders/{id}/return-partial-decline', [OrderController::class, 'buyerDeclinePartial']);
$router->post('/orders/{id}/return-escalate', [OrderController::class, 'buyerEscalate']);
...
$router->post('/orders/{id}/arbiter-refund', [OrderController::class, 'arbiterFullRefund']);
$router->post('/orders/{id}/arbiter-partial', [OrderController::class, 'arbiterPartialRefund']);
...
$router->post('/ai/action/confirm', [AiAssistantController::class, 'confirmAction']);
...
$router->post('/digital/studio/{id}/provision', [DigitalController::class, 'studioProvision']);
$router->post('/digital/studio/{id}/go-live', [DigitalController::class, 'studioGoLive']);
$router->post('/digital/studio/{id}/end', [DigitalController::class, 'studioEnd']);
...
$router->get('/admin/ai', [AdminController::class, 'aiDashboard']);
$router->post('/admin/ai/prompt-rollback', [AdminController::class, 'aiPromptRollback']);
$router->post('/admin/ai/reindex', [AdminController::class, 'aiReindexKnowledge']);
$router->post('/admin/ai/learning-process', [AdminController::class, 'aiProcessLearning']);
$router->post('/admin/ai/prompt-approve', [AdminController::class, 'aiApprovePromptCandidate']);
$router->get('/admin/stream', [AdminController::class, 'streamSettings']);
$router->post('/admin/stream', [AdminController::class, 'streamSettingsSave']);
